...
<template>
  <section class="carousel-demo-container">
    <carousel :speed="1" direction="horizontal" :pauseTime="1.5e3" class="demo-vertical">
      <div v-for="(item, index) in items" :key="index" :style="item"></div>
    </carousel>
  </section>
</template>
